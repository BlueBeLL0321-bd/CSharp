...
namespace Override
{
    ...
    public abstract class CarBase
    {
        ...
        // private를 선언한 클래스 코드 블록 안에서만 사용 가능
    ...
    {
        // 모든 자동차에 공통
        public CarType Style { set; get; }

        // 생성자 - 매개 변수를 입력 받아 CarType 초기화
        ...
        // 부모의 추상 메서드를 실제 코드로 구현, 재정의
        public override void Left()
        {
            // base 키워드를 부모 멤버에 접근(public, protected)
    ...
    // sealed(봉인) 키워드를 통해 봉인 클래스 설정 - 더 이상 상속이 안 된다
    public sealed class Mirae : Car
    {
